                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-8"><?= !empty($user['year_level']) ? esc($user['year_level']) : '<span class="text-muted">Not set</span>' ?></dd>
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-8">
                                    <?= !empty($user['address']) ? esc($user['address']) : '<span class="text-muted">Not set</span>' ?>
                                </dd>
                            </dl>
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-8"><?= !empty($user['created_at']) ? date('F j, Y', strtotime($user['created_at'])) : 'N/A' ?></dd>

                                <dt class="col-sm-4">Last Updated:</dt>
                                <dd class="col-sm-8"><?= !empty($user['updated_at']) ? date('F j, Y g:i A', strtotime($user['updated_at'])) : 'N/A' ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
